  ...
  return (
    <section className="welcome" aria-labelledby="welcome-title">
      ...
      <div className="welcome__content">
        <p className="eyebrow welcome__eyebrow"><span className="eyebrow__line" /> PARA GRACE, CON AMOR <span className="eyebrow__line" /></p>
        ...
        <button className="open-button" type="button" onClick={onOpen}>
          Entrar a nuestra historia <span className="open-button__arrow" aria-hidden="true">↗</span>
        </button>
      </div>
